  ...
  <AppLayout main-class="max-w-4xl w-full">
    ...
    <form @submit.prevent="submit" class="space-y-6">
      ...
      <div class="flex flex-wrap items-center justify-end gap-3 pt-2">
        <Link :href="`/@${article.user.username}/${article.slug}`" class="rounded-md px-4 py-2 text-sm font-medium text-zinc-600 hover:text-zinc-900 dark:text-zinc-400 dark:hover:text-zinc-100 transition-colors">
          Cancelar
        </Link>
        <button 
          type="submit"
